...
class CampTix_Payment_Method_Dwolla extends CampTix_Payment_Method {
    ...
    function payment_settings_fields() {
        ...
        $this->add_settings_field_helper( 'test', __( 'Test Mode', 'camptix' ), array( $this, 'field_yesno' ),
            'Set to "<strong>Yes</strong>" to run in test mode, regardless of sandbox or production mode. All transactions will have the transactionID of "1" and will process regardless of available funds. No actual transfers will occur.' );
    }
